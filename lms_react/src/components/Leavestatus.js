...
const Leavestatus = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        const employee_leaves = await axios.get('https://lms-techp.uc.r.appspot.com/lms/apply/');
      ...
      const deleteleave = async (leaveId)  => {
        ...
        try {
          await axios.delete(`https://lms-techp.uc.r.appspot.com/lms/update/${leaveId}`);
