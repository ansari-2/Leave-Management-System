...
const LeaveForm = () => {
  ...
  const fetchEmployees = async () => {
    ...
    const employee = await axios.get(`https://lms-techp.uc.r.appspot.com/lms/employee/update/${emp.id}`);
  ...
  const handleLeaveChange = async (e) => {
    ...
    try {
      const response = await axios.get(`https://lms-techp.uc.r.appspot.com/lms/leave_type/update/${leaveid[0]["id"]}`);
   ...
   if(selectedleave in Leave_type_data){
    ...
    try {
      const response = await axios.put(
        `https://lms-techp.uc.r.appspot.com/lms/leave_type/updat/${employeeleaveTypes['id']}`,
        Leave_type_data
      );
    ...
    try {
      const response = await axios.post(
        'https://lms-techp.uc.r.appspot.com/lms/apply/',
        LeaveData
      );
      console.log('Data submitted successfully:', response.data);
