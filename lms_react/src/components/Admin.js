...
const Admin = () => {
    ...
    useEffect(() => {
      ...
      const fetchleaves = async () => {
        try {
          const response = await axios.get('https://lms-techp.uc.r.appspot.com//lms/apply/');
      ...
      const fetchleave_types = async () => {
        try {
          const response = await axios.get('https://lms-techp.uc.r.appspot.com//lms/leave_type/');
      ...
      const rejectleave = async (leaveId)  => {
        ...
        let getleave = await axios.get(`https://lms-techp.uc.r.appspot.com//lms/update/${leaveId}`)
        ...
        try {
          await axios.put(`https://lms-techp.uc.r.appspot.com//lms/update/${leaveId}`,getleave.data);
      ...
      const approveleave = async (leaveId)  => {
        ...
        // let leave_types = await axios.get('https://lms-techp.uc.r.appspot.com//lms/leave_type')
        ...
        try {
            await axios.put(`https://lms-techp.uc.r.appspot.com//lms/leave_type/update/${getleave_type.id}`,getleave_type);
            fetchleaves()
        } catch (error) {
            console.error('Error fetching employees:', error);
        }
