...
const Login = () => {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      const response = await fetch('https://lms-techp.uc.r.appspot.com/api/login/', {
        method: 'POST',
        headers: {
    ...
    try {
      const employees = await axios.get('https://lms-techp.uc.r.appspot.com/lms/employee/');
      ...
      const leavetypes = await axios.get('https://lms-techp.uc.r.appspot.com/lms/leave_type/')
    try {
      console.log(user.id)
